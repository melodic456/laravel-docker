    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="{{ route('roadmap') }}" class="nav-item nav-link {{ request()->routeIs('roadmap') ? 'active' : '' }}">Roadmap</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle {{ request()->routeIs(['feature', 'token', 'faq']) ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu shadow-sm m-0">
                        <a href="{{ route('feature') }}" class="dropdown-item {{ request()->routeIs('feature') ? 'active' : '' }}">Feature</a>
                    
                        <a href="{{ route('faq') }}" class="dropdown-item {{ request()->routeIs('faq') ? 'active' : '' }}">FAQs</a>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-phone-alt me-3"></i>0964311227</p>
                    <p>
