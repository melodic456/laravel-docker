...
|
*/
// Route::get('/newpage', [TestingController::class, 'show']);
...
if ($installed === true) {
    ...
    Route::group(['middleware'=>'XSS'],function(){
        ...
        Route::group(['middleware'=>'auth','Is_Admin'],function(){
            ...
            Route::get('/update_database', 'UpdateController@viewStep1')->name('update_database');

            Route::get('/update_database/finish', function () {
                return view('update.finishedUpdate');
            })->name('update_database_finish');
        ...
        Route::group(['middleware'=>'auth'],function(){
            ...
            Route::get("Get_all_employees", "EmployeesController@Get_all_employees")->name('get_all_employees');
            Route::get("Get_employees_by_company", "EmployeesController@Get_employees_by_company")->name('get_employees_by_company');
            Route::get("Get_employees_by_department", "EmployeesController@Get_employees_by_department")->name('get_employees_by_department');
            Route::get("Get_office_shift_by_company", "EmployeesController@Get_office_shift_by_company")->name('get_office_shift_by_company');
            ...
            Route::prefix('core')->group(function () {
                ...
                Route::get("Get_all_Company", "CompanyController@Get_all_Company")->name('get_all_company');
                ...
                Route::get("get_designations_by_department", "DesignationsController@Get_designations_by_department")->name('get_designations_by_department');
